...
public class SMSController
{
	...
	@CrossOrigin()
	@RequestMapping(value = "/getSMSTemplates", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON,
			headers = "Authorization")
	public String getSMSTemplates(@ApiParam(value="\"{\\\"providerServiceMapID\\\":\\\"Integer\\\"}\"")@RequestBody SMSRequest request, HttpServletRequest serverRequest)
	{
...
//		logger.info("getSMSTemplates sending response");
		return response.toString();
	}

	@CrossOrigin()
	@RequestMapping(value = "/getFullSMSTemplate", method = { RequestMethod.POST },
			produces = MediaType.APPLICATION_JSON, headers = "Authorization")
	public String getFullSMSTemplate(@ApiParam(value="\"{\\\"providerServiceMapID\\\":\\\"Integer\\\",\\\"smsTemplateID\\\":\\\"Integer\\\"}\"")
	@RequestBody SMSRequest request, HttpServletRequest serverRequest)
	{
		OutputResponse response = new OutputResponse();
...
//		logger.info("getFullSMSTemplate sending response");
		return response.toString();
	}

	@CrossOrigin()
	@RequestMapping(value = "/saveSMSTemplate", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON,
			headers = "Authorization")
	public String saveSMSTemplate(@ApiParam(value="\"{\\\"createdBy\\\":\\\"String\\\",\\\"providerServiceMapID\\\":\\\"String\\\",\\\"smsParameterMaps\\\":\\\"String\\\",\\\"smsTemplate\\\":\\\"String\\\",\\\"smsTemplateName\\\":\\\"String\\\",\\\"smsTypeID\\\":\\\"Integer\\\"}\"")
	@RequestBody CreateSMSRequest request, HttpServletRequest serverRequest)
	{
		OutputResponse response = new OutputResponse();
...
//		logger.info("saveSMSTemplate sending response");
		return response.toString();
	}

	@CrossOrigin()
	@RequestMapping(value = "/updateSMSTemplate", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON,
			headers = "Authorization")
	public String updateSMSTemplate(@ApiParam(value="\"{\\\"smsTemplateID\\\":\\\"String\\\",\\\"smsTemplateName\\\":\\\"String\\\",\\\"smsTemplate\\\":\\\"String\\\","
			...
			+ "\\\"createdDate\\\":\\\"Timestamp\\\",\\\"lastModDate\\\":\\\"Timestamp\\\",\\\"modifiedBy\\\":\\\"String\\\"}\"")
	@RequestBody UpdateSMSRequest request, HttpServletRequest serverRequest)
	{
		OutputResponse response = new OutputResponse();
	...
	@CrossOrigin()
	@RequestMapping(value = "/getSMSTypes", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON,
			headers = "Authorization")
	public String getSMSTypes(@ApiParam(value="\"{\\\"serviceID\\\":\\\"Integer\\\"}\"")
	@RequestBody SMSTypeModel request, HttpServletRequest serverRequest)
	{
		OutputResponse response = new OutputResponse();
	...
	@CrossOrigin()
	@RequestMapping(value = "/getSMSParameters", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON,
			headers = "Authorization")
	public String getSMSParameters(@ApiParam(value="\"{\\\"serviceID\\\":\\\"Integer\\\"}\"")
	@RequestBody SMSParameterModel request, HttpServletRequest serverRequest)
	{
		OutputResponse response = new OutputResponse();
	...
	@CrossOrigin()
	@RequestMapping(value = "/sendSMS", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON,
			headers = "Authorization")
	public String sendSMS(@ApiParam(value="\"{\\\"providerServiceMapID\\\":\\\"Integer\\\",\\\"smsTemplateTypeID\\\":\\\"Integer\\\","
			...
			+ "\\\"imrID\\\":\\\"String\\\",\\\"nodalNumber\\\":\\\"String\\\",\\\"informerName\\\":\\\"String\\\"}\"")
	@RequestBody String request, HttpServletRequest serverRequest)
	{
		OutputResponse response = new OutputResponse();
