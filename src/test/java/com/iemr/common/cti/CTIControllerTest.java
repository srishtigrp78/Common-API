...
public class CTIControllerTest
{
	...
	public void addUpdateAgentSkillsSuccess01()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ContantAddUpdateAgentSkills.responseSuccess1, OutputResponse.class))
					.when(ctiServiceSpy)
					.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestSuccess1, Constants.REQUESTOR_IP);
			String response = "";
			response = controllerMock.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestSuccess1, request)
					.toString();
			assertTrue("addUpdateAgentSkills success 1 ",
					response.equals(ContantAddUpdateAgentSkills.controllerResponseSuccess1));
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	public void addUpdateAgentSkillsSuccess02()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ContantAddUpdateAgentSkills.responseSuccess2, OutputResponse.class))
					.when(ctiServiceSpy)
					.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestSuccess2, Constants.REQUESTOR_IP);
			String response = "";
			response = controllerMock.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestSuccess2, request)
					.toString();
			assertTrue("addUpdateAgentSkills success 2 ",
					response.equals(ContantAddUpdateAgentSkills.controllerResponseSuccess2));
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	public void addUpdateAgentSkillsFailure01()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ContantAddUpdateAgentSkills.responseFailure1, OutputResponse.class))
					.when(ctiServiceSpy)
					.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure1, Constants.REQUESTOR_IP);

			String response = "";
			response = controllerMock.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure1, request)
					.toString();
			assertTrue("addUpdateAgentSkills failure 1 ",
					response.equals(ContantAddUpdateAgentSkills.controllerResponseFailure1));
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	public void addUpdateAgentSkillsFailure02()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ContantAddUpdateAgentSkills.responseFailure2, OutputResponse.class))
					.when(ctiServiceSpy)
					.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure2, Constants.REQUESTOR_IP);

			String response = "";
			response = controllerMock.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure2, request)
					.toString();
			assertTrue("addUpdateAgentSkills failure 2 ",
					response.equals(ContantAddUpdateAgentSkills.controllerResponseFailure2));
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	public void addUpdateAgentSkillsFailure03()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ContantAddUpdateAgentSkills.responseFailure3, OutputResponse.class))
					.when(ctiServiceSpy)
					.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure3, Constants.REQUESTOR_IP);

			String response = "";
			response = controllerMock.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure3, request)
					.toString();
			assertTrue("addUpdateAgentSkills failure 3 ",
					response.equals(ContantAddUpdateAgentSkills.controllerResponseFailure3));
	...
	public void addUpdateAgentSkillsFailure04()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ContantAddUpdateAgentSkills.responseFailure4, OutputResponse.class))
					.when(ctiServiceSpy)
					.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure4, Constants.REQUESTOR_IP);

			String response = "";
			response = controllerMock.addUpdateAgentSkills(ContantAddUpdateAgentSkills.requestFailure4, request)
					.toString();
			assertTrue("addUpdateAgentSkills failure 4 ",
					response.equals(ContantAddUpdateAgentSkills.controllerResponseFailure4));
		} catch (Exception e)
		{
			e.printStackTrace();
	...
	public void doAgentLoginSuccess01()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ConstantAgentLogin.successResponse1, OutputResponse.class))
					.when(ctiServiceSpy).doAgentLogin(ConstantAgentLogin.successRequest1, Constants.REQUESTOR_IP);
			String response = "";
			response = controllerMock.doAgentLogin(ConstantAgentLogin.successRequest1, request).toString();
			assertTrue("doAgentLogin success 1 ", response.equals(ConstantAgentLogin.controllerSuccessResponse1));
		} catch (Exception e)
		{
			e.printStackTrace();
			fail("doAgentLogin success 1 failed with error " + e.getMessage(), e);
		}
	}
	...
	public void doAgentLoginFailure01()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ConstantAgentLogin.failureResponse1, OutputResponse.class))
					.when(ctiServiceSpy).doAgentLogin(ConstantAgentLogin.failureRequest1, Constants.REQUESTOR_IP);

			String response = "";
			response = controllerMock.doAgentLogin(ConstantAgentLogin.failureRequest1, request).toString();
			assertTrue("doAgentLogin failure 1 ", response.equals(ConstantAgentLogin.controllerFailureResponse1));
		} catch (Exception e)
		{
			e.printStackTrace();
			fail("doAgentLogin failure 1 failed with error " + e.getMessage(), e);
		}
	}
	...
	public void doAgentLoginFailure02()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ConstantAgentLogin.failureResponse2, OutputResponse.class))
					.when(ctiServiceSpy).doAgentLogin(ConstantAgentLogin.failureRequest2, Constants.REQUESTOR_IP);

			String response = "";
			response = controllerMock.doAgentLogin(ConstantAgentLogin.failureRequest2, request).toString();
			assertTrue("doAgentLogin failure 2 ", response.equals(ConstantAgentLogin.controllerFailureResponse2));
		} catch (Exception e)
		{
			e.printStackTrace();
			fail("doAgentLogin failure 2 failed with error " + e.getMessage(), e);
		}
	}
	...
	public void doAgentLoginFailure03()
	{
		try
		{
			doReturn(InputMapper.gson().fromJson(ConstantAgentLogin.failureResponse3, OutputResponse.class))
					.when(ctiServiceSpy).doAgentLogin(ConstantAgentLogin.failureRequest3, "");

			String response = "";
			response = controllerMock.doAgentLogin(ConstantAgentLogin.failureRequest3, requestNoIP).toString();
			assertTrue("doAgentLogin failure 3 ", response.equals(ConstantAgentLogin.controllerFailureResponse3));
		} catch (Exception e)
		{
			e.printStackTrace();
			fail("doAgentLogin failure 3 failed with error " + e.getMessage(), e);
		}
	}
