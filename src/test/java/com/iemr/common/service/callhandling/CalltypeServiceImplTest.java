...
class CalltypeServiceImplTest {
    ...
    @Disabled()
    @Test()
    void getAllCalltypesV1WhenCallGroupIsNull() throws JSONException, IEMRException, JsonMappingException, JsonProcessingException {
    ...
    @Disabled()
    @Test()
    void getAllCalltypesV1WhenObjectLengthGreaterThanOrEqualsTo8AndCallGrpIndexNotLessThanCallGroupTypesLengthAndCallGroupIsNull() throws JSONException, IEMRException, JsonMappingException, JsonProcessingException {
    ...
    @Disabled()
    @Test()
    void getAllCalltypesV1WhenCallGrpIndexNotLessThanCallGroupTypesLengthAndCallGroupIsNull3() throws JSONException, IEMRException, JsonMappingException, JsonProcessingException {
    ...
    @Disabled()
    @Test()
    void getAllCalltypesV1WhenCallGrpIndexNotLessThanCallGroupTypesLengthAndCallGroupIsNull4() throws JSONException, IEMRException, JsonMappingException, JsonProcessingException {
