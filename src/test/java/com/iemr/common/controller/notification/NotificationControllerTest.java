...
class NotificationControllerTest {
	...
	@Test
	void testGetNotification() throws IEMRException {
		String request = "{}";
	...
	@Test
	void testGetSupervisorNotification() throws IEMRException {
		String request = "{}";
		String expectedResponse = "{\"data\":{\"response\":\"any response\"},\"statusCode\":200,\"errorMessage\":\"Success\",\"status\":\"Success\"}";
	...
	@Test
	void testGetSupervisorNotification_Exception() throws IEMRException {
		String request = "{\"statusCode\":5000,\"errorMessage\":\"Failed with generic error\",\"status\":\"FAILURE\"}";
	...
	@Test
	void testCreateNotificationType() throws IEMRException {
		String request = "{}";
		String expectedResponse = "{\"data\":{\"response\":\"any response\"},\"statusCode\":200,\"errorMessage\":\"Success\",\"status\":\"Success\"}";
