...
class CommonControllerTest {
	...
	@Test
	void getCategoriesTest() throws IEMRException {
	...
	@Test
	void testGetSubcategories() throws IEMRException {
	...
	@Test
	void testGetSubCategoryFilesWithURL() throws IEMRException {
		String request = "{\"categoryID\":\"1\", \"providerServiceMapID\":\"1\", " + "\"subCategoryID\":\"1\"}";
		OutputResponse response = new OutputResponse();
	...
	@Test
	void testGetcategoriesById() throws IEMRException {
	...
	@Test
	void testGetservicetypes() throws IEMRException {
